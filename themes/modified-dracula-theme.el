...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-3 ((,class (:bold nil :foreground ,rainbow-6 :height 1.12))))
   ...
   ;;telephone line
   `(telephone-line-accent-active ((,class (:inherit mode-line :background "red" :foreground "white"))))
  ; `(mode-line-inactive ((,class (:inherit mode-line :background "black" :foreground "white"))))
   ;; rainbow-delimiters
...
(provide-theme 'modified-dracula)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; modified-dracula-theme.el ends here
